...
MODEL_NAME = 'bert-kor-cnn3_1' # 짧은 상호명 증강만 켜기
...
class TokenDataset(Dataset):
    # 증강 확률 0.5로 조정 - 짧은 상호명 증강만 쓰기 때문
    def __init__(self, dataframe, tokenizer_pretrained, max_len, augment_prob=0.5, is_train=True):
        self.data = dataframe
